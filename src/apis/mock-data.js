  ...
  board: {
    ...
    columns: [
      ...
      },
      {
         ...
         * Phía FE sẽ tự tạo ra một cái card đặc biệt: Placeholder Card, ko liên quan tới BE
         * Card đặc biệt này sẽ đc ẩn ở giao diện UI người dùng.
         * Cấu trúc Id của cái card này để Unique rất đơn giản, ko cần phải random phức tạp:
         ...
         * ** Kỹ hơn nữa về cách tạo chuẩn ở bc nào thì sẽ ở học phần tích hợp API BE vào dự án. (bởi vì đây là file mock-data)
        */
